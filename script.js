...
function updateCompetitive() {
    ...
    renderChart('chartShareChange', {
        ...
        plotOptions: { bar: { horizontal: true, barHeight: '55%', borderRadius: 3, dataLabels: { position: 'top' } } },
        dataLabels: { enabled: true, formatter: v => (v > 0 ? '+' : '') + v.toFixed(2) + 'pp', offsetX: 30,
...
function updateProfitability() {
    ...
    renderChart('chartROE', {
        ...
        plotOptions: { bar: { horizontal: true, barHeight: '55%', borderRadius: 3, distributed: true, dataLabels: { position: 'top' } } },
        dataLabels: { enabled: true, formatter: v => commaFmt(v, 1) + '%', offsetX: 30, style: { fontSize: '11px', fontWeight: 600, colors: ['#333'] } },
        xaxis: { labels: { formatter: v => v.toFixed(0) + '%', style: { fontSize: '11px' } } },
        yaxis: { labels: { style: { fontSize: '12px', fontWeight: 600 } } },
        legend: { show: false },
        grid: { borderColor: '#f0f0f0' },
    ...
    renderChart('chartROA', {
        ...
        plotOptions: { bar: { horizontal: true, barHeight: '55%', borderRadius: 3, distributed: true, dataLabels: { position: 'top' } } },
        dataLabels: { enabled: true, formatter: v => commaFmt(v, 2) + '%', offsetX: 30, style: { fontSize: '11px', fontWeight: 600, colors: ['#333'] } },
        xaxis: { labels: { formatter: v => v.toFixed(1) + '%', style: { fontSize: '11px' } } },
        yaxis: { labels: { style: { fontSize: '12px', fontWeight: 600 } } },
        legend: { show: false },
        grid: { borderColor: '#f0f0f0' },
